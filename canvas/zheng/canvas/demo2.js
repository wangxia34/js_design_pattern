...
LinearGradient.prototype.draw = function () {
    ...
    // 曲线
    this.ctx.bezierCurveTo(this.data.ctrlA[0], this.data.ctrlA[1] , this.data.ctrlB[0] , this.data.ctrlB[1], this.data.end[0], this.data.end[1]);
...
LinearGradient.prototype.isbiaoji = function(arr) {
